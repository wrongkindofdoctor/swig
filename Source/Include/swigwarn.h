...
#define WARN_FORTRAN_TYPEMAP_FIN_UNDEF      770
#define WARN_FORTRAN_TYPEMAP_FOUT_UNDEF     771
#define WARN_FORTRAN_TYPEMAP_FCREATE_UNDEF  772
#define WARN_FORTRAN_TYPEMAP_FRELEASE_UNDEF 773
#define WARN_FORTRAN_TYPEMAP_FDATA_UNDEF    774
